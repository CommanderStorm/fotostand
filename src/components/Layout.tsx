    ...
    <html>
      ...
      >
        ...
        <footer class="fixed bottom-0 w-full py-4 text-center text-sm opacity-70">
          <a href="https://www.sv.tum.de/sv/datenschutz/" target="_blank" rel="noopener noreferrer" class="hover:underline mx-2">Data Protection</a>
          <span>|</span>
          <a href="https://www.sv.tum.de/sv/impressum/" target="_blank" rel="noopener noreferrer" class="hover:underline mx-2">Imprint</a>
        </footer>
      </body>
    </html>
  );
